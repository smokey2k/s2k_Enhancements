...
function BuildOptionsPanel()
    ...
    do
        ...
        AddControl(page, MakeCheckbox(content, "WeakAuraManageBarGroups", "Enable top/bottom progress bar groups", "Creates and width-syncs only the fixed groups s2k_NP_BT and s2k_NP_BB. WeakAuras owns their anchor/offset; this addon only syncs width.", "weakAuraManageBarGroups", 16, y)); y = y - 38
